...
class IconColors {
  ...
  ///{}
  ///</summary>
  Map<String, Color> homeView = {};

  ///<summary>
  ///"arrowBack": Color(0xFFE1C2EB)
  ///</summary>
  Map<String, Color> loginView = {
    "arrowBack": Color(0xFFE1C2EB),
  };
  ...
  ///</summary>
  Map<String, Color> signupView = {
    "arrowBack": Color(0xFFE1C2EB),
    "upload": Color(0xFF707070),
  };
  ...
  Map<String, Color> friendView = {
    "call": Color(0xFFB3B2FF),
    "cam": Color(0xFFB3B2FF),
    "notification": Color(0xFF504DE5),
    "active": Color(0xFF4EEA4E),
    "inactive": Color(0xFFB5B5B5),
    "search": Color(0xFFC6C6C6)
  };
  ...
  ///"arrowBack": Color(0xFFE1C2EB)
  ///</summary>
  Map<String, Color> searchingView = {
    "arrowBack": Color(0xFFE1C2EB),
  };
  ...
  Map<String, Color> bottomNavigationBar = {
    "active": Color(0xFF7C79FF),
    "inactive": Color(0xFF6F8BA4),
    "search": Color(0xFF8BB1FB),
  };
